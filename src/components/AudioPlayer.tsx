...
const AudioPlayer = ({ audioData }: AudioPlayerProps) => {
  ...
  useEffect(() => {
    ...
    studyWaveVoice.setCallbacks({
      ...
      onError: (error) => {
        // Using inline toast call to avoid dependency
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative bg-card/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 p-6 sm:p-8">
        ...
        <div 
          ref={waveformRef}
          className="h-16 mb-6 bg-black/20 rounded-xl flex items-center justify-center overflow-hidden"
        >
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                size="icon"
                onClick={() => skipTime(-15)}
                className="h-12 w-12 rounded-xl hover:bg-white/10 transition-all"
              >
          ...
          <Button
            ...
            className="h-16 w-16 rounded-full bg-gradient-to-br from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 shadow-lg shadow-primary/25 transition-all hover:scale-105 active:scale-95"
          >
            {isPlaying && !isPaused ? (
